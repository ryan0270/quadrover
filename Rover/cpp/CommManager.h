...
class CommManagerListener
{
	...
	virtual void onNewCommImgProcBoxColorCenter(toadlet::egg::Collection<int> const &data){};
	virtual void onNewCommImgProcBoxColorHalfRange(toadlet::egg::Collection<int> const &data){};
	virtual void onNewCommImgProcSatMin(int val){};
	virtual void onNewCommImgProcSatMax(int val){};
	virtual void onNewCommImgProcValMin(int val){};
	virtual void onNewCommImgProcValMax(int val){};
	virtual void onNewCommImgProcCircMin(int val){};
	virtual void onNewCommImgProcCircMax(int val){};
	virtual void onNewCommImgProcConvMin(int val){};
	virtual void onNewCommImgProcConvMax(int val){};
	virtual void onNewCommImgProcAreaMin(int val){};
	virtual void onNewCommImgProcAreaMax(int val){};
	virtual void onNewCommImgViewType(int val){};
