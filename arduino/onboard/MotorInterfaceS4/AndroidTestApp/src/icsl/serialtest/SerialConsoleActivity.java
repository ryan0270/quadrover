...
public class SerialConsoleActivity extends Activity {
    ...
    private final SerialInputOutputManager.Listener mListener =
		...
		private final static byte HEX_NEWLINE_STR=0x0A;
		private final static byte HEX_CARRIAGE_RETURN_STR=0x0D;
...
Log.i(TAG,"Bob is: " + Integer.toBinaryString(valBytes));
